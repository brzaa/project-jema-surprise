...
export function Candle({ isLit = true, ...groupProps }: CandleProps) {
    ...
    useFrame(({ clock }, delta) => {
        ...
        flameUniforms.strength.value = THREE.MathUtils.damp(
        ...
        lightStrengthRef.current = THREE.MathUtils.damp(
